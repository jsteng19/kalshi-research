...
Usage example:
  python -m src.scrapers.netanyahu.rank_events \
...
try:
    ...
    from src.scrapers.netanyahu.extract_govil_news import extract_date_from_url as extract_date_from_url_helper
